...
namespace ZXing.OneD
{
	...
	public sealed class Code128Writer : OneDimensionalCodeWriter
	{
														...
														IDictionary<EncodeHintType, object> hints)
		{
			...
			manualCodesets = (hints != null &&
												hints.ContainsKey(EncodeHintType.CODE128_MANUAL_SUBSET_CONTROL) &&
												(bool)hints[EncodeHintType.CODE128_MANUAL_SUBSET_CONTROL]);
